...
class UpdateProductRequest extends FormRequest
{
    ...
    {
        // Chỉ tạo slug nếu có name trong request
        if ($this->name) {
            $this->merge([
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // Ignore ID hiện tại để không bị lỗi Unique chính nó
    ...
    public function messages(): array
    {
        return [
            ...
            'slug.unique' => 'Tên sản phẩm này đã tồn tại (trùng slug), vui lòng chọn tên khác.',
            'sale_price.lt' => 'Giá khuyến mãi phải nhỏ hơn giá bán gốc.',
            'thumbnail.image' => 'File tải lên phải là định dạng ảnh.',
            'thumbnail.mimes' => 'Ảnh chỉ chấp nhận định dạng: jpeg, png, jpg.',
