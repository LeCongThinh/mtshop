...
@section('web-title', 'MTShop - Thêm mới bài viết')
@section('header-title', 'Thêm mới bài viết')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            @if(session('error'))
            ...
            @endif
            <form action="{{ route("admin.posts.store") }}" method="POST" class="p-3" enctype="multipart/form-data" novalidate>
                @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text"
                                    ...
                                    id="title" name="title" value="{{ old('title') }}" placeholder="Nhập tiêu đề bài viết">
                                @error('title')
                                ...
                                <div class="mt-2">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" id="description" name="content" rows="3"
                ...
                <div class="d-flex justify-content-end gap-2 mb-5">
                    <button type="submit" class="btn btn-primary px-5">Thêm mới bài viết</button>
